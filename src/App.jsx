...
function App() {
  ...
  return (
    <div className="w-screen h-screen">
      ...
      ">
        <div className='text-3xl md:text-5xl bg-white shadow-lg font-bold rounded-lg h-24 md:h-32 w-2/3 flex justify-center items-center hover:bg-black hover:text-white md:hover:text-7xl transition-all duration-500 ease-in-out'>Add Your Business
