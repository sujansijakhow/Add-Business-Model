...
function App() {
  ...
  return (
    <div className="w-screen h-screen">
      ...
      ">
        <div className='text-7xl bg-white shadow-lg font-bold rounded-lg h-32 w-2/3 flex justify-center items-center hover:bg-black hover:text-white transition-all duration-500 ease-in-out'>Add Your Business
